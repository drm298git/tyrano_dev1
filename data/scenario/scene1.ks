...
;メッセージウィンドウの設定
[position layer="message0" top=400 height=200 page=fore visible=true]
...
;キャラクターの名前が表示される文字領域
[ptext name="chara_name_area" layer="message0" color="white" size=24 x=190 y=500]
...
民主、自由、そして平和の概念がネットワークによって揺さぶられ[l][r]

電子化された情報と懐疑心、個人の欲望が渦巻き、[l][r]
そしてそれらが飛び交う近未来。[l][cm]

どんなにテクノロジーが進化しようとも[l][r]

どんなにヒトとヒトとの距離が縮まろうとも[l][r]

ヒトという生命体、それらの共同体は[l][r]

数万年前から未だ進化しようとしない……[l][cm]

[cm]
;メッセージウィンドウの設定
[position layer="message0" top=490 height=200 page=fore visible=true]
;キャラクターの名前が表示される文字領域
[ptext name="chara_name_area" layer="message0" color="white" size=24 x=190 y=500]


;背景画像の切り替え実行
[bg storage= battlefield_0.jpg time=3000]


銃声、爆発音、空を翔ける鉄塊の轟音、無数の金属と金属が軋む不快音[l][r]
兵器を片手に立ち向かう男、子供を抱えながら逃げ惑う女、親を失いその場で叫び散らす子供。[l][cm]
たどる結末はすべからく同じだ。[l] それらは鉛玉と鉄片の雨、炎のシャワーを浴び、肉塊と化してゆく。[p][l][cm]
原型を留めたまま眠っているもの、ひしゃげたもの、黒く焦げたもの。[l][r]
鉄、酸、肉の焼き焦げた強烈な臭気が、一箇所でごちゃ混ぜにかき混ぜられ[l][r]
それらは五感に訴えかけている。この場所にとどまる者の末路を。[l][cm]


……かーん、きょうかーん？[l][cm]
[bg  time="1000"  method="crossfade" storage="classroom.jpg"  ]

教官？　教官、きょうかーん[l][r]
ダメですねぇ。完全に入り込んじゃってます。どうします？[p]

これだけ声をかけても返事がない。これは座学講習は中止ということだろうか……[p]
...
何言ってのよ！　講習中にぼーっとする方が悪いでしょ！[p]

[glink  color="blue"  storage="scene1.ks"  size="20" width="400"  y="100"  text="うるせえ！　後ろでスクワット百回！"  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="20" width="400"  y="170"  text="すまんすまん　授業再開！"  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="20" width="400"  y="240"  text="別の訓練性に話を振る"  target="*selectinterest"  ]
*selectinterest
